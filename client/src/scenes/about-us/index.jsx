    ...
    <Box>
      ...
      >
        ...
        >
          ...
          <Avatar
            alt="Creator"
            src="https://friendsvault-bucket.s3.us-east-2.amazonaws.com/Owner/Sanjay_T.jpg" 
      ...
      >
        ...
        <Box flexBasis={isNonMobileScreens ? "50%" : "100%"} textAlign="center">
          <img
            ...
            src="https://friendsvault-bucket.s3.us-east-2.amazonaws.com/Owner/FriendsVault+Logo.png" // Add the correct path for the image
            alt="Lawn Mower"
            style={{
